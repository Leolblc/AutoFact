namespace AutoFact.Vue
{
    partial class Form3
    {
        ...
        private void InitializeComponent()
        {
            ...
            TB_LasName_ENT = new TextBox();
            TB_Name_INFO = new TextBox();
            TB_Address_INFO = new TextBox();
            TB_Mail_INFO = new TextBox();
            TB_Phone_INFO = new TextBox();
            LB_Titre_INFO = new Label();
            ...
            label1.Location = new Point(341, 180);
            label1.Name = "label1";
            ...
            label2.Location = new Point(766, 195);
            label2.Name = "label2";
            ...
            label4.Location = new Point(766, 326);
            label4.Name = "label4";
            ...
            label5.Location = new Point(338, 488);
            label5.Name = "label5";
            ...
            // BTN_Update_INFO
            // 
            BTN_Update_INFO.Location = new Point(811, 559);
            BTN_Update_INFO.Name = "BTN_Update_INFO";
            BTN_Update_INFO.Size = new Size(131, 23);
            BTN_Update_INFO.TabIndex = 9;
            BTN_Update_INFO.Text = "Mettre à jour";
            BTN_Update_INFO.UseVisualStyleBackColor = true;
            BTN_Update_INFO.Click += BTN_Update_INFO_Click;
            // 
            // TB_LasName_ENT
            // 
            TB_LasName_ENT.Location = new Point(341, 223);
            ...
            // TB_Name_INFO
            // 
            TB_Name_INFO.Location = new Point(766, 223);
            TB_Name_INFO.Name = "TB_Name_INFO";
            TB_Name_INFO.Size = new Size(233, 23);
            TB_Name_INFO.TabIndex = 11;
            // 
            // TB_Address_INFO
            // 
            TB_Address_INFO.Location = new Point(338, 371);
            TB_Address_INFO.Name = "TB_Address_INFO";
            TB_Address_INFO.Size = new Size(216, 23);
            TB_Address_INFO.TabIndex = 12;
            // 
            // TB_Mail_INFO
            // 
            TB_Mail_INFO.Location = new Point(766, 371);
            TB_Mail_INFO.Name = "TB_Mail_INFO";
            TB_Mail_INFO.Size = new Size(233, 23);
            TB_Mail_INFO.TabIndex = 13;
            // 
            // TB_Phone_INFO
            // 
            TB_Phone_INFO.Location = new Point(338, 560);
            TB_Phone_INFO.Name = "TB_Phone_INFO";
            TB_Phone_INFO.Size = new Size(213, 23);
            TB_Phone_INFO.TabIndex = 14;
            // 
            // LB_Titre_INFO
            // 
            LB_Titre_INFO.AutoSize = true;
            LB_Titre_INFO.Font = new Font("Segoe UI", 26F, FontStyle.Bold);
            LB_Titre_INFO.Location = new Point(334, 64);
            LB_Titre_INFO.Name = "LB_Titre_INFO";
            LB_Titre_INFO.Size = new Size(217, 47);
            LB_Titre_INFO.TabIndex = 15;
            LB_Titre_INFO.Text = "Information";
            // 
            // Form3
            // 
            ...
            Controls.Add(LB_Titre_INFO);
            Controls.Add(TB_Phone_INFO);
            Controls.Add(TB_Mail_INFO);
            Controls.Add(TB_Address_INFO);
            Controls.Add(TB_Name_INFO);
            Controls.Add(TB_LasName_ENT);
        ...
        private TextBox TB_LasName_ENT;
        private TextBox TB_Name_INFO;
        private TextBox TB_Address_INFO;
        private TextBox TB_Mail_INFO;
        private TextBox TB_Phone_INFO;
        private Label LB_Titre_INFO;
